...
class Price extends BaseSellerController {
    ...
    public function index() {
        ...
        //分页
        // $pagecfg = array();
        // $pagecfg['base_url']     = _create_url(ADMIN_SITE_URL.'/price', $arrParam);
    ...
    public function add()
    {
        ...
        $this->load->view('admin/oil/price_add',$result);
    }
    ...
    public function save()
    {
        if ($this->input->is_post())
        {
            ...
            if ($this->form_validation->run() === TRUE)
            {
                ...
                redirect(ADMIN_SITE_URL.'/price?company_id='.$company_id);
            }
        }
    }
