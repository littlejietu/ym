...
class Goods extends MY_Admin_Controller {
	...
	public function index()
	{
		...
		$search_commonid = $this->input->post('search_commonid');
		...
		$arrWhere['status <>'] = -1;
		$goods_list = $this->Goods_model->fetch_page($page, $pagesize, $arrWhere,'*');
		...
		$this->load->view('admin/goods',$result);
	}
	/**
	 * 违规下架商品
	 */
	...
	public function lockup_save()
	{
	    ...
	    if ($this->input->get('id'))
	    {
	        ...
	        $this->Goods_model->update_by_id($id,$data);
	    }
	    if($this->input->post('id'))
	    {
	        ...
	        {
	            $this->Goods_model->update_by_id($value,$data);
	        }
	    }
...
// 	    var_dump($_POST);exit;
	...
	public function del()
	{
	    ...
	    redirect(ADMIN_SITE_URL.'/goods/goods_lockup');
	}
