...
class Goods_tpl_album extends MY_Admin_Controller {
	...
	public function pic_list(){
        ...
        switch($item) {
        case 'goods':
            Tpl::showpage('goods_add_step2_master_image','null_layout','seller');
            break;
        case 'goods_color':
            ...
            break;
        case 'des':
            Tpl::showpage('goods_add_step2_desc_image','null_layout','seller');
            break;
        // case 'groupbuy':
        ...
        //     break;
        case 'goods_image':
            Tpl::showpage('goods_add_step3_goods_image', 'null_layout','seller');
            break;
        case 'mobile':
            Tpl::output('type', $this->input->get('type'));
            Tpl::showpage('goods_add_step2_mobile_image', 'null_layout','seller');
            break;
        }
    }
}