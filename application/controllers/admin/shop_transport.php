...
class Shop_transport extends MY_Admin_Controller {
	...
	public function index(){
        ...
        //分页
        $pagecfg = array();
        $pagecfg['base_url']     = _create_url(ADMIN_SITE_URL.'/shop_transport', $arrParam);
	    ...
	    $this->load->view('admin/shop_transport',$result);
	}
	...
	public function add()
	{
	    ...
	    $this->load->view('admin/shop_transport_add',$result);
	}
	...
	public function del()
	{
	    ...
	    redirect(ADMIN_SITE_URL.'/shop_transport');
	}
	...
	public function save()
	{
	    ...
	    $shop_id = -1;//$this->input->post('shop_id');
