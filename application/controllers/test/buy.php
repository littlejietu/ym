...
class Buy extends CI_Controller {
    ...
    public function buy(){
        ...
        $arrOrderIds = $this->order_service->createOrderList($cart, $arrBuy, $addressId, $invoiceId);
    ...
    public function paying(){
        ...
        $arrReturn = $this->order_service->gotoPay($orderIds, C('PayMethodType.AllBalance'), $ip);
