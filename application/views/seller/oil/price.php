...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <!-- <li><a href="<?php echo ADMIN_SITE_URL.'/price/add?company_id='.(!empty($arrParam['company_id'])?$arrParam['company_id']:0);?>"><span>添加加油站</span></a></li> -->
      </ul>
    </div>
  </div>
  ...
  <form method="post" id='form_admin' action="<?php echo ADMIN_SITE_URL.'/price/del'?>">
    <table class="table tb-type2">
      ...
      <?php if(!empty($list['rows']) && is_array($list['rows'])): ?>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><?php echo $v['site_id'];?></td>
          ...
          <td class="w150 align-center">
            <a href="javascript:void(0)" onclick="if(confirm('您确定要删除吗?')){location.href='<?php echo ADMIN_SITE_URL.'/price/del?id='.$v['id']; ?>'}">删除</a> | 
            <a href="<?php echo ADMIN_SITE_URL.'/price/add?id='.$v['id']; ?>">编辑</a>|
