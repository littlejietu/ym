...
<div class="ncsc-login-container">
  ...
  <form id="form_login" action="/seller/Login/seller_login" method="post" >
    <div class="input">
      <label>用户名</label>
    ...
    <div class="input">
      ...
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img">
            <a href="javascript:void(0)" nctype="btn_change_seccode"><img src="/seller/Login/captcha?<?php echo rand(10000,9999);?>" onclick="this.src='/seller/Login/captcha?'+Math.random()" name="codeimage" border="0" id="codeimage"></a>
        </div>
