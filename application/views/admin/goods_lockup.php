...
<div class="page">
  ...
  <form method="post" name="formSearch" id="formSearch" action="<?php echo ADMIN_SITE_URL.'/goods/goods_lockup';?>">
  ...
  <form method='post' id="form_goods" action="<?php echo ADMIN_SITE_URL.'/goods/del'?>">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><?php echo $v['id'];?></td>
          <td class="w60"><div class="goods-picture"><span class="thumb size-goods"><i></i><img src="<?php if (!empty($v['pic_path'])){echo UPLOAD_SITE_URL.'/'.ATTACH_GOODS.'/'.$v['shop_id'].'/'.$v['pic_path'];}else echo RES_SITE_URL.'/admin/images/default_image.png';?>" onload="javascript:DrawImage(this,56,56);"/></span></div></td>
          ...
          <td><p><?php echo $category_list['data'][$v['category_id_1']]['name'].'->'.$category_list['data'][$v['category_id_2']]['name'].'->'.$category_list['data'][$v['category_id_3']]['name'];?></p>
          ...
          <td class="align-center"><p><?php echo '违规下架';?></p></td>
          <td class="w48 align-center"><a href="###" target="_blank"><?php echo lang('nc_view');?></a>&nbsp;|&nbsp;<a href="<?php echo ADMIN_SITE_URL.'/goods/del?id='.$v['id'];?>" ><?php echo lang('nc_del');?></a></td>
        </tr>
      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td colspan="16"><label for="checkallBottom"><?php echo lang('nc_select_all'); ?></label>
            &nbsp;&nbsp;<a id="submit" href="javascript:void(0)" class="btn"><span>删除</span></a>
