...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <li><a href="JavaScript:void(0);"><span><?php echo lang('admin_add_limit_admin');?></span></a></li>
      <li><a href="<?php echo ADMIN_SITE_URL.'/admin/admin_role';?>" class="current"><span><?php echo lang('limit_gadmin');?></span></a></li>
