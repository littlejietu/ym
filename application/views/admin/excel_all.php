...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
      <li><a href="JavaScript:void(0);" class="current"><span><?php echo lang('export_all');?></span></a></li>
  ...
  <form id="adv_form" method="post" action="<?php echo ADMIN_SITE_URL.'/excel/export_excel_all'?>">
