...
<div class="page">
  ...
  <form method="post" name="formSearch" id="formSearch" action="<?php echo ADMIN_SITE_URL.'/goods'?>">
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <td><input type="text" value="<?php if (!empty($arrParam['search_commonid'])){echo $arrParam['search_commonid'];}?>" name="search_commonid" id="search_commonid" class="txt" /></td>
        ...
        <tr>
          ...
          <td><select name="search_state">
              ...
              <option value="<?php echo $key;?>" <?php if (!empty($arrParam['search_state']) && $key ==$arrParam['search_state']){?>selected="selected"<?php }?>><?php echo $val;?></option>
              <?php }?>
            </select></td>
  ...
  <form method='post' id="form_goods" action="<?php echo ADMIN_SITE_URL.'/goods/lockup_save'?>">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center"><a href="###" target="_blank"><?php echo lang('nc_view');?></a>&nbsp;|&nbsp;<a href="<?php echo ADMIN_SITE_URL.'/goods/lockup_save?id='.$v['id']?>" >违规下架</a></td>
        </tr>
      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td colspan="16"><label for="checkallBottom"><?php echo lang('nc_select_all'); ?></label>
            &nbsp;&nbsp;<a id="submit" href="javascript:void(0)" class="btn"><span>违规下架</span></a>
