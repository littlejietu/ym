...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>平台充值卡</h3>
      <ul class="tab-base">
        <li><a href="<?php echo ADMIN_SITE_URL.'/recharge_card/';?>"><span>列表<?php echo lang('adv_manage');?></span></a></li>
        <li><a href="<?php echo ADMIN_SITE_URL.'/recharge_card/add';?>" class="current"><span>新增</span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="post" enctype="multipart/form-data" name="form_add" id="form_add" action="<?php echo ADMIN_SITE_URL.'/recharge_card/save'?>">
