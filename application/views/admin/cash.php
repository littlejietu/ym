		...
		<tr>
            <td height="32">
                <form class="form-horizontal" role="form" method="get">
                    ...
                    <option value="1" <?php if (isset($_GET['type']) && $_GET['type'] == 1){?>selected="selected"<?php }?>>申请中</option>
                    <option value="2" <?php if (isset($_GET['type']) && $_GET['type'] == 2){?>selected="selected"<?php }?>>成功</option>
                    <option value="3" <?php if (isset($_GET['type']) && $_GET['type'] == 3){?>selected="selected"<?php }?>>失败</option>
                    </select>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="nowrap"><?php echo $v['netpay_account']; ?></td>
          <td class="nowrap"><?php echo date('Y-m-d H:i:s',$v['create_time']);?></td>
          <td class="nowrap"><?php echo $v['fee_amt']; ?></td>
          ...
          <a href="<?php echo ADMIN_SITE_URL.'/cash/audit?id='.$v['fund_order_id'];?>">详情</a>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
