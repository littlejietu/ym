...
<div class="page">
  ...
  <form id="article_class_form" method="post" action="<?php echo ADMIN_SITE_URL.'/article_class/save'?>">
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="ac_parent_id" id="ac_parent_id">
              ...
              <option  <?php if ($parent_id == $v['id']){echo 'selected="selected"';}?> value="<?php echo $v['id'];?>"><?php echo $v['name'];?></option>
              <?php } ?>
              <?php } ?>
            </select></td>
